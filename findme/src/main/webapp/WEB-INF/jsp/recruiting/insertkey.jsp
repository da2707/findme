...
<body>
    ...
    <div class="container" id="container">
        <div>
            <div class="col-md-2">
                <h1 class="text-center" style="width:190px;margin-left:-16px;">키워드 등록</h1>
            ...
            <div class="col-md-10" id="content"><button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" style="margin-left:34px;">등록</button>
